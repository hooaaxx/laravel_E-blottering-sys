        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            <div @click.away="open = false"
                ...
                <nav :class="{'block': open, 'hidden': !open}"
                    ...
                    <x-admin-link   :href="route('brgy.pending.index')"
                                    :active="request()->routeIs('brgy.pending.index')"
                    >Pending Blotter List
                    </x-admin-link>
                    <x-admin-link   :href="route('brgy.approved.index')"
                                    :active="request()->routeIs('brgy.approved.index')"
                    >Approved Blotter List
                    </x-admin-link>
                    <x-admin-link   :href="route('brgy.case-closed.index')"
                                    :active="request()->routeIs('brgy.case-closed.index')"
                    >Case Closed List
                    </x-admin-link>
                    <x-admin-link   :href="route('brgy.revive.index')"
                                    :active="request()->routeIs('brgy.revive.index')"
                    >Revive Blotter List
                    </x-admin-link>
