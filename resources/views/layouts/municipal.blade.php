    ...
    <body class="font-sans antialiased">
        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            <div @click.away="open = false"
                ...
                >
                    <x-admin-link   :href="route('municipal.brgyblotter.index')"
                                    :active="request()->routeIs('municipal.brgyblotter.index')"
                    >Brgy Blotter List
                    </x-admin-link>
                    <x-admin-link   :href="route('municipal.municipalblotter.index')"
                                    :active="request()->routeIs('municipal.municipalblotter.index')"
                    >Municipal Blotter List
                    </x-admin-link>
